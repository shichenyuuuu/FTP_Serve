...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Local_path.setGeometry(QtCore.QRect(270, 190, 270, 30))#修改local输入框
        #新增按键
        self.Local_file_address = QtWidgets.QPushButton(Form)
        self.Local_file_address.setObjectName("Local_file_address")
        self.Local_file_address.setGeometry(QtCore.QRect(200, 190, 50, 30))



        self.Remote_Home = QtWidgets.QPushButton(Form) #单击绑定cdToRemoteHomeDirectory
    ...
    def retranslateUi(self, Form):
        ...
        self.Local_file_address.setIcon(qIcon('folder.png'))

        self.Remote_Next.setIcon(qIcon('next.png'))#增加图标
        self.Remote_Return.setIcon(qIcon('back.png'))
        self.Remote_Home.setIcon(qIcon('home.png'))


        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Ftp客户端文件传输"))#修改窗口名称
